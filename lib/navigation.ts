...
export const sidebarItems: NavGroup[] = [
  {
    ...
    items: [
      ...
      { title: 'Support Coordination', url: '/cos', icon: HeadphonesIcon },
      { title: 'Allied Health', url: '/ah', icon: Stethoscope },
      { title: 'Rostering', url: '/rostering', icon: ClipboardList },
      { title: 'Home Management', url: '/home-management', icon: Home },
      { title: 'Incident Management', url: '/incident-management', icon: ShieldAlert },
