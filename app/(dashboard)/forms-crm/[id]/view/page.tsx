...
import { useCrmForm } from '@/hooks/use-crm-forms';
...
export default function ViewCRMFormPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div className="flex flex-col gap-6 p-6 max-w-5xl mx-auto w-full">
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-[var(--color-text-secondary)]">CRM Management</span>
        </div>
      ...
      <div className="flex justify-end pt-4">
        <Button variant="outline" onClick={() => router.push('/forms-crm')}>
          Clear & Exit
        </Button>
      </div>
    </div>
