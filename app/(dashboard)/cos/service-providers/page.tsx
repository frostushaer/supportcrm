...
import { useServiceProviders, useDeleteServiceProvider } from '@/hooks/use-cos';

import { Edit2, Plus, Trash2 } from 'lucide-react';
import { AddServiceProviderDialog } from '@/components/cos/add-service-provider-dialog';
...
export default function ServiceProvidersPage() {
  ...
  const { data: providers, isLoading } = useServiceProviders({ search });
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        <PageHeader
          ...
          description="Manage external providers for Support Coordination."
        />
