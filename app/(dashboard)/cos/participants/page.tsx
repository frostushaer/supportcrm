...
import { useCosParticipants } from '@/hooks/use-cos';
...
export default function CosParticipantsPage() {
  ...
  const { data: participants, isLoading } = useCosParticipants({
    managementStyle,
    activeStatus,
    search
  });
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="COS Participants"
        description="List of all Support Coordination participants."
      />
