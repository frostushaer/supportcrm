    ...
    <div suppressHydrationWarning>
      ...
      >
        ...
        <SidebarInset className="flex flex-col overflow-hidden peer-data-[variant=inset]:border">
          <header className="flex h-12 shrink-0 items-center gap-2 border-b bg-[var(--color-bg)] transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
